<template>
  <ui-container>
    ...
    <!-- 添加学生 -->
    <el-dialog title="添加学生" :visible.sync="addStudentModel" width="30%" center>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="addStudentModel = false">取 消</el-button>
        <el-button type="warning" @click="addStudentReadCard">读 卡</el-button>
        <el-button type="primary" @click="addStudentOk">确 定</el-button>
      </div>
    </el-dialog>
    <!-- 删除学生 -->
    <el-dialog title="提示" :visible.sync="delStudentModel" width="300px" center>
